MESSAGES = {
    "asset_not_found": "资产「{name}」does not exist",
    ...
    "asset_source_resource_not_found": "项目「{project}」中does not exist{kind}「{name}」",
    "asset_target_project_not_found": "目标项目「{project}」does not exist",
