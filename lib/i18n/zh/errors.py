MESSAGES = {
    "project_not_found": "项目 '{name}' does not exist或未初始化",
    ...
    "script_not_found": "剧本 '{name}' does not exist",
    "scene_not_found": "场景 '{id}' does not exist",
    "segment_not_found": "片段 '{id}' does not exist",
    "script_missing": "剧本does not exist",
    ...
    "task_not_found": "任务 '{id}' does not exist",
    ...
    "storyboard_task_submitted": "分镜「{segment_id}」生成任务Submitted",
    ...
    "video_task_submitted": "视频「{segment_id}」生成任务Submitted",
    "character_not_found": "角色 '{char_name}' does not exist",
    "character_task_submitted": "角色「{char_name}」设计图生成任务Submitted",
    "scene_task_submitted": "场景「{name}」设计图生成任务Submitted",
    "prop_task_submitted": "道具「{name}」设计图生成任务Submitted",
    # Files
    "file_not_found": "文件does not exist: {path}",
    ...
    "draft_file_not_found": "草稿文件does not exist",
    ...
    "credentials_not_found": "凭证does not exist",
    ...
    # Assistant
    "session_not_found": "会话 '{session_id}' does not exist",
    "session_or_project_not_found": "会话或Project does not exist",
    ...
    "provider_not_found": "供应商does not exist",
