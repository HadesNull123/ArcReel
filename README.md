...
- **Advanced Cinematic AI Directing** — Built-in rules enforce the 180-degree rule, psychological perspective (low/high angles), logical shot diversity (wide -> medium -> close-up), and creative match cuts for seamless transitions.
